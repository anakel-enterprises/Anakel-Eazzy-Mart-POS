      ...
      {!error && !loading && mergedSales.length > 0 && (
        <div className="overflow-x-auto">
          <div className="min-w-[560px]">
            <div className="grid grid-cols-[1.1fr_0.7fr_0.9fr_1fr] gap-2 border-b border-brand-border pb-2 text-[11.5px] font-semibold text-brand-inkMuted">
              <span>DATE</span>
              <span>ITEMS</span>
              <span>TOTAL</span>
              <span>SOLD BY</span>
              ...
              return (
                <div key={s.id} className="border-b border-brand-border/60">
                  <button
                    ...
                    className={`grid w-full grid-cols-[1.1fr_0.7fr_0.9fr_1fr] items-center gap-2 py-2.5 text-left text-sm hover:bg-brand-bg ${
